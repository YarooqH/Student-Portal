...
public class AdminStudentController implements Initializable {
    ...
    private void deleteAccount(ActionEvent event) {
        try {
            queryId = (adminStudentTable.getSelectionModel().getSelectedItem());
            ...
            query = "DELETE FROM Students WHERE Email_Address = " + "'" + userData[2] + "'";
            try {
            ...
            ad.loadStage("/StudentPortal/src/fxml/Admin-Students-New.fxml", event);
